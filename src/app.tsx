...
export function App(prop: { setup: ShogiKit }) {
   ...
   // const [marker, setMarker] = useState(markerAt.split(','));
    ...
    const {plays:movesArray,branches, initialComment:comment  }= preProcessMoves(moves!);
    ...
    return <Board pieces={unifiedPieces} moves={movesArray} branches={branches} caption={caption || ""}
